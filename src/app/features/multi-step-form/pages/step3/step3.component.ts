...
export class Step3Component implements OnInit {
  ...
  get spaceForDevice() {
    return this.installationForm.get('spaceForDevice');
  }
  get spaceUncluttered() {
    return this.installationForm.get('spaceUncluttered');
  }
  get deviceInPublicArea() {
    return this.installationForm.get('deviceInPublicArea');
  }
  get outletWithin5ft() {
    return this.installationForm.get('outletWithin5ft');
  }
  get cablesConcealable() {
    return this.installationForm.get('cablesConcealable');
  }
  get mountingAllowed() {
    return this.installationForm.get('mountingAllowed');
  }
  get layoutImage() {
    return this.installationForm.get('layoutImage');
  }
